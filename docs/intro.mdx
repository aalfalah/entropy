...
<!-- ![alt text](../static/img/image.png){.img-right} -->

<!-- <img src="image.png" alt="alt text" style="float: right; width: 200px; margin-left: 20px;" /> -->

![alt text](../static/img/file.jpg)

import React from 'react';

<!-- <img src="img/image.png" alt="alt text" style={{ float: "right", width: "200px", marginLeft: "20px" }} />

<img src="/img/image.png" alt="alt text2" style={{ float: "right", width: "200px", marginLeft: "20px" }} /> -->
